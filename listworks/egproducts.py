...
#q2 total stock
stk=[mob[-1] for mob in mobiles ]
print(f"total stock: {sum(stk)}")

# q3 print mobiles available in range 20k to 30k
ava_mob=[mob for mob in mobiles if mob[4]>=20000 and mob[4]<=30000]
print(f" mobiles available in range 20k to 30k: {ava_mob}")

# q4 print all 5g phone
fi_g_ph=[mob for mob in mobiles if mob[2]=="5g"]
print(f"5g phones: {fi_g_ph}")

# q5 print samsung mobiles
sam_mob=[mob for mob in mobiles if mob[5]=="samsung"]
